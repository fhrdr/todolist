...
inline QColor border()         { return isDark() ? QColor(0x2E, 0x38, 0x54) : QColor(0xC7, 0xD1, 0xE3); }
inline QColor borderStrong()   { return isDark() ? QColor(0x3D, 0x4A, 0x6B) : QColor(0xAA, 0xB8, 0xCE); }
inline QColor textPrimary()    { return isDark() ? QColor(0xEA, 0xF0, 0xFA) : QColor(0x1E, 0x29, 0x3B); }
inline QColor textSecondary()  { return isDark() ? QColor(0x9D, 0xAC, 0xC6) : QColor(0x4E, 0x5C, 0x76); }
inline QColor textMuted()      { return isDark() ? QColor(0x6E, 0x7E, 0x9C) : QColor(0x80, 0x8E, 0xA6); }
inline QColor textDisabled()   { return isDark() ? QColor(0x51, 0x5E, 0x76) : QColor(0xA9, 0xB2, 0xC2); }
...
inline QColor glassBg()        { return isDark() ? QColor(255, 255, 255, 13)  : QColor(255, 255, 255, 205); }
inline QColor glassBgStrong()  { return isDark() ? QColor(255, 255, 255, 22)  : QColor(255, 255, 255, 230); }
inline QColor glassBorder()    { return isDark() ? QColor(255, 255, 255, 30)  : QColor(178, 190, 210, 210); }
inline QColor glassHighlight() { return isDark() ? QColor(255, 255, 255, 46)  : QColor(255, 255, 255, 255); }
